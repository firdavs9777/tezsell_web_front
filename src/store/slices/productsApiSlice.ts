...
export const { useGetProductsQuery, useGetCategoryListQuery, useGetRegionsListQuery, useGetAllLocationListQuery, useGetDistrictsListQuery, useCreateProductMutation } = productsApiSlice;
