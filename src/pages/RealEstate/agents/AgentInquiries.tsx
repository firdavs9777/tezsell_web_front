    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
          ...
          <p className="text-red-700 mb-4">Unable to load your inquiries. Please try again.</p>
          <button
            onClick={() => refetch()}
    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Agent Inquiries</h1>
            <p className="text-gray-600 mt-1">Manage and respond to property inquiries</p>
          </div>
          <button
            onClick={() => refetch()}
            ...
            return (
              <div
                ...
                className={`bg-white rounded-xl shadow-sm border-l-4 ${
                  inquiry.is_responded ? 'border-l-green-500' : 'border-l-yellow-500'
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-900 font-medium">{inquiry.user.username}</p>
