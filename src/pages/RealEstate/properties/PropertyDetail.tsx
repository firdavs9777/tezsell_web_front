...
const RealEstateDetail: React.FC = () => {
  ...
  const [createInquiry, { isLoading: isSubmittingInquiry }] =
    useCreatePropertyInquiryMutation();
  ...
  const getPropertyWithCoordinates = (
    property: ExtendedProperty
  ): ExtendedProperty => {
  ...
  const handleEmailContact = (
    contactInfo: PropertyOwner | RealEstateAgent | undefined
  ) => {
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">
            {t("loading.propertyNotFound")}
          </h2>
          <p className="text-gray-600 mb-4">
            {t("loading.propertyNotFoundMessage")}
          </p>
          <button
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center space-x-4 text-sm text-gray-500">
                <div className="flex items-center">
                  ...
                  <span>
                    {property.views_count} {t("propertyInfo.views")}
                  </span>
                </div>
                <div className="flex items-center">
                  <FaCalendarAlt className="mr-1" />
                  <span>
                    {t("propertyInfo.listed")}{" "}
            ...
            <div className="text-right">
              ...
              {property.listing_type === "sale" && property.price_per_sqm && (
                <div className="text-sm text-gray-600">
                  {Math.round(Number(property.price_per_sqm))}{" "}
                  {property.currency}
                  {t("propertyInfo.pricePerSqm")}
                </div>
              )}
                  ...
                  {propertyImages.map((image, index) => (
                    ...
                    >
                      <img
                        ...
                        onError={(e) => {
                          e.currentTarget.src =
                            "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=80&h=64&fit=crop";
                        }}
                      />
                    </button>
                  ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-semibold text-lg mb-3">
                    {t("propertyDetails.basicInformation")}
                  </h3>
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-3">
                    {t("propertyDetails.featuresAmenities")}
                  </h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {property.metro_distance && (
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-600">
                        {property.metro_distance}m {t("amenities.away")}
                      </div>
                    </div>
                  )}
                  {property.school_distance && (
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-600">
                        {property.school_distance}m {t("amenities.away")}
                      </div>
                    </div>
                  )}
                  {property.hospital_distance && (
                    <div className="text-center">
                      <div className="font-medium">
                        {t("amenities.hospital")}
                      </div>
                      <div className="text-sm text-gray-600">
                        {property.hospital_distance}m {t("amenities.away")}
                      </div>
                    </div>
                  )}
                  {property.shopping_distance && (
                    <div className="text-center">
                      <div className="font-medium">
                        {t("amenities.shopping")}
                      </div>
                      <div className="text-sm text-gray-600">
                        {property.shopping_distance}m {t("amenities.away")}
                      </div>
                    </div>
                  )}
                </div>
              ...
              {property.agent ? (
                <div className="text-center">
                  ...
                  <div className="font-semibold text-lg">
                    {t("contact.professionalListing")}
                  </div>
                  <div className="text-gray-600 mb-2">
                    {t("contact.listedByAgent")}
                  </div>
                ...
                <div className="text-center">
                  ...
                  <div className="font-medium text-gray-800 mb-4">
                    {property.owner?.username || t("contact.propertyOwner")}
                  </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  >
                    {property.is_active && !property.is_sold
                      ? t("propertyStatus.available")
                      : t("propertyStatus.notAvailable")}
                  </span>
                </div>
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="text-blue-600 font-bold text-xl mb-2">
                      {formatPrice(
                        Number(relatedProperty.price),
                        relatedProperty.currency,
                        relatedProperty.listing_type
                      )}
                    </div>
                    <div className="flex items-center text-gray-600 text-sm">
                      <FaMapMarkerAlt className="mr-1" />
                      <span>
                        {relatedProperty.district}, {relatedProperty.city}
                      </span>
                    </div>
                    <button
                      onClick={() =>
          ...
          <div className="bg-white rounded-lg max-w-sm w-full p-6">
            <div className="text-center">
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div className="text-sm text-gray-600">
                  {property.agent
                    ? t("contact.agentPhoneNumber")
                    : t("contact.ownerPhoneNumber")}
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setInquiryData((prev) => ({
                      ...prev,
                      inquiry_type: e.target.value as
                        | "viewing"
                        | "info"
                        | "offer"
                        | "callback",
                ...
                >
                  ...
                  <option value="viewing">
                    {t("inquiry.scheduleViewing")}
                  </option>
                  <option value="offer">{t("inquiry.makeOffer")}</option>
                  <option value="callback">
                    {t("inquiry.requestCallback")}
                  </option>
                </select>
              </div>
